...
class RoomStore(RoomBackgroundUpdateStore, RoomWorkerStore, SearchStore):
    ...
    def quarantine_media_by_id(
        ...
        Args:
            quarantined_by: The ID of the user who made the quarantine request
            media_id: The ID of the media to quarantine
            media_origin: The server the media originated from. Set to None if local
        """
        ...
        def _quarantine_media_by_id_txn(txn):
            ...
            # Check if this is local or remote media, and add to the appropriate list
            if media_origin:
                remote_mxcs.append((media_origin, media_id))
            else:
                local_mxcs.append(media_id)
        ...
        return self.db.runInteraction(
            "quarantine_media_by_id", _quarantine_media_by_id_txn
        )
